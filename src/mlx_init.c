...
/*   Updated: 2022/03/02 01:59:15 by lde-la-h      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static bool	mlx_init_render(t_mlx *mlx)
{
	...
	if (!mlx_compile_shader(vert_shader, GL_VERTEX_SHADER, &s[0]) || \
		!mlx_compile_shader(frag_shader, GL_FRAGMENT_SHADER, &s[1]))
