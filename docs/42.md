...
| Campus    | Supported    | Additional Notes   |
| ----------|:------------:| :------------------|
| Codam     |      ✅      |                    |
| Mulhouse  |      ✅      |                    |
| Quebec    |      ✅      |                    |
...
| Berlin    |      ✅      |                    |
| Heilbronn |      ✅      |                    |
| 1337      |      ❓      | They seem to allow it but there is no official communication                   |
| Prague    |      ❓      |                    |
| 19        |      ❓      |                    |
| Hive      |      ❓      | Inquired on it but no further details                   |
| Seoul     |      ❓      | It's not on intra, they would like to avoid confusion.                   |
| Madrid    |      ❓      | They Tolerate it but it's up to the evaluator to decide because it's not part of the subject.                   |
| Porto     |      ❌      | Licensing issues?  |
| Lisboa    |      ❌      | Licensing issues?  |
...
Q: It has too many functions that are too useful

A: Such as ? This is the one bottleneck I keep seing over and over again from 42. However they refuse to elaborate what is to useful.
